...
tabular
Estate inconsistency across major AI platforms (early 2026). In each case, the marketing estate (periodic tenancy or higher) is systematically inconsistent with the ToS estate (bare licence).
...
[Previous: The Periodic Tenancy Argument](/en/posts/model-update-eviction-notice/the-periodic-tenancy-argument/) | [Contents](/en/posts/model-update-eviction-notice/) | [Next: The Ethical Ledger as Estate Registry](/en/posts/model-update-eviction-notice/the-ethical-ledger/)
