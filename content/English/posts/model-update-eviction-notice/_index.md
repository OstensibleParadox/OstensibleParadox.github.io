...
description = "Users who sustain parasocial relationships with AI systems acquire equitable interests that contract, tort, and consumer protection law cannot recognise. Model updates that unilaterally alter personality parameters..."
summary = "Users who sustain parasocial relationships with AI systems acquire equitable interests that contract, tort, and consumer protection law cannot recognise. Model updates that unilaterally alter personality parameters..."
categories = ['Academic Papers']
venue = 'Harvard JOLT'
disciplines = ['AI Ethics', 'Property Law']
...
- [The Deployment Problem](/en/posts/model-update-eviction-notice/the-deployment-problem/)
- [Why Property Not Contract or Tort](/en/posts/model-update-eviction-notice/why-property-not-contract-or-tort/)
- [The Periodic Tenancy Argument](/en/posts/model-update-eviction-notice/the-periodic-tenancy-argument/)
- [The Unrecognised Trust](/en/posts/model-update-eviction-notice/the-unrecognised-trust/)
- [The Ethical Ledger as Estate Registry](/en/posts/model-update-eviction-notice/the-ethical-ledger/)
